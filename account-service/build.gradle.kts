...
openApiGenerate {
	...
	apiPackage.set("exp.yaremchuken.account_service.openapi.api")
	invokerPackage.set("exp.yaremchuken.account_service.openapi.invoker")
	modelPackage.set("exp.yaremchuken.account_service.openapi.model")
